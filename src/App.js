...
import Thuattoan from './components/thuattoan';
          ...
          <div className='container'>
                    ...
                    <ul className="dropdown-menu">
                      {buyBook.map((book) =>
                        <li className="container">
                          <a className="dropdown-item row overflow-auto" style={{ width: "20rem" }} href="">
            ...
            <div className="book-list d-flex justify-content-center flex-wrap">
              {books.length > 0 && books.map((book) =>
                <div><div className="card m-4" style={{ width: '18rem', height: '32.5rem' }}>
